...
// Page d'accueil : route /home-page (redirection / → /home-page).
// Contenu et design alignés sur l'app Vue.
// Pas de useRouter : recherche non fonctionnelle, à brancher dans une story ultérieure.
...
<template>
  ...
  >
    ...
    <NuxtLink
      to="/results"
      class="mt-6 inline-flex items-center gap-2 px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium"
    >
