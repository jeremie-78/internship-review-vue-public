...
|---------|--------|-------------|
| [setup](./branches/01-setup/README.md) | 🔄 En cours | Créer la page d'accueil avec composants (décrit travail pour 02-home-page) |
| [02-home-page](./branches/02-home-page/README.md) | ⏳ À venir | Afficher la liste des offres (décrit travail pour 03-affichage-offres) |
